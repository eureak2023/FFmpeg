...
/* Right-click context menu (blocks until dismissed). The fsr/nr/fg/lada/
 * jasna/dlss flags set the checkmarks on the video-effects submenu;
 * fg_mult (2/3/4) checks the
